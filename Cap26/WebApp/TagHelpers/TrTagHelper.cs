...
{
    //[HtmlTargetElement("tr", Attributes = "bg-color,text-color", ParentTag = "thead")] //Aplica me um unico elemento
    //[HtmlTargetElement("*", Attributes = "bg-color,text-color")] //Perigoso
